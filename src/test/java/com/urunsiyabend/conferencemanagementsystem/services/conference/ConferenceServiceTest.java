...
import com.urunsiyabend.conferencemanagementsystem.repositories.ConferenceRepository;
...
class ConferenceServiceTest {
    ...
    void createSession() throws SessionNotFoundServiceException, ConferenceNotFoundException, InvalidSessionException {
        conferenceService.createSession(1, new Session(3, "Title", new Date(2024, 5, 15, 12, 30, 0), new Date(2024, 5, 15, 13, 30, 0)));
        assertDoesNotThrow(() ->
        ...
        assertThrows(InvalidSessionException.class, () ->
                conferenceService.createSession(1, new Session(4, "Title", new Date(2024, 5, 15, 12, 30, 0), new Date(2024, 5, 15, 13, 0, 0)))

        );

        assertDoesNotThrow(() ->
                conferenceService.createSession(1, new Session(5, "Title", new Date(2024, 6, 15, 12, 30, 0), new Date(2024, 6, 15, 13, 0, 0))));

        assertDoesNotThrow(() ->
                conferenceService.createSession(2, new Session(4, "Title", new Date(2024, 5, 15, 12, 30, 0), new Date(2024, 5, 15, 13, 0, 0))));
